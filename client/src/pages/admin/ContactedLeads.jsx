...
const ContactedLeads = () => {
  ...
  const [activeTab, setActiveTab] = useState('Contacted Leads');
  ...
  // Filter contactedLeads based on searchTerm (name, phone, CNIC, email)
  const filteredLeads = contactedLeads.filter(lead => {
  ...
  return (
    <div className="w-auto space-y-5 py-6 bg-white">
      ...
      <LeadsHeaderButtons
        ...
        onAdd={() => <Navigate to='/admin/leads/add' />}
        onImport={() => <Navigate to='/admin/leads/import' />}
